...
// 表示纸张上的数字填充格，在MMSE量表中为括号内的得分，暂定只有方形的情况
// 功能为获取表格上的笔迹
public class VirtualNumGrid {
    ...
    public VirtualNumGrid(int center_x, int center_y, int width, float scalingFactor, int tolerance, String id) {
